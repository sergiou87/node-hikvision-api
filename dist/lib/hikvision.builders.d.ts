import { EventTrigger, Integrations, MotionDetection, OnvifUserType, StreamingChannel } from '../types';
...
export declare const buildEventTrigger: (eventTrigger: EventTrigger) => string;
