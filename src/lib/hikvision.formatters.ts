...
export const formatStreamCapabilities = (
  raw: RawCapabilityResponse,
): StreamCapabilities => {
  return {
    Transport: {
      ControlProtocolList: {
        ControlProtocol: {
          streamingTransport: {
            current:
              raw.StreamingChannel.Transport.ControlProtocolList.ControlProtocol
                .streamingTransport['#text'],
            options:
              raw.StreamingChannel.Transport.ControlProtocolList.ControlProtocol.streamingTransport.prop_opt.split(
                ',',
              ),
          },
        },
      ...
      Multicast: {
        videoDestPortNo: {
          ...
          max: raw.StreamingChannel.Transport.Multicast.videoDestPortNo
            .prop_max,
          default:
            raw.StreamingChannel.Transport.Multicast.videoDestPortNo
              .prop_default,
        },
        audioDestPortNo: {
          ...
          max: raw.StreamingChannel.Transport.Multicast.audioDestPortNo
            .prop_max,
          default:
            raw.StreamingChannel.Transport.Multicast.audioDestPortNo
              .prop_default,
        },
      },
      Security: {
        certificateType: {
          current:
            raw.StreamingChannel.Transport.Security.certificateType['#text'],
          options:
            raw.StreamingChannel.Transport.Security.certificateType.prop_opt.split(
              ',',
            ),
        },
        SecurityAlgorithm: {
          algorithmType: {
            current:
              raw.StreamingChannel.Transport.Security.SecurityAlgorithm.algorithmType.prop_opt.split(
                ',',
              )[0],
            options:
              raw.StreamingChannel.Transport.Security.SecurityAlgorithm.algorithmType.prop_opt.split(
      ...
      SRTPMulticast: {
        SRTPVideoDestPortNo: {
          ...
          max: raw.StreamingChannel.Transport.SRTPMulticast.SRTPVideoDestPortNo
            .prop_max,
          default:
            raw.StreamingChannel.Transport.SRTPMulticast.SRTPVideoDestPortNo
              .prop_default,
        },
        SRTPAudioDestPortNo: {
          ...
          max: raw.StreamingChannel.Transport.SRTPMulticast.SRTPAudioDestPortNo
            .prop_max,
          default:
            raw.StreamingChannel.Transport.SRTPMulticast.SRTPAudioDestPortNo
              .prop_default,
        },
      },
    },
    Video: {
      ...
      videoQualityControlType: {
        ...
        options:
          raw.StreamingChannel.Video.videoQualityControlType.prop_opt.split(
            ',',
          ),
      },
      constantBitRate: {
    ...
    Audio: {
      audioCompressionType: {
        ...
        options:
          raw.StreamingChannel.Audio.audioCompressionType.prop_opt.split(','),
      },
    },
    isSpportDynamicCapWithCondition:
      raw.StreamingChannel.isSpportDynamicCapWithCondition,
    isSupportSmartCodeWithoutReStart:
      raw.StreamingChannel.isSupportSmartCodeWithoutReStart,
